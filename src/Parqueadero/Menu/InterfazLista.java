    ...
    void llenarTabla(){
        for (Parqueo listacliente : ArrayList_Parqueo.listaclientes) {
            modelo.addRow(new Object[]{
                ...
                listacliente.getPropietario().getDni(), listacliente.getPropietario().Vehiculo.getplaca(), 
                listacliente.getPropietario().Vehiculo.gettipoVehiculo(), listacliente.getHoraDeEntrada(), listacliente.getHoraDeSalida()
            });
        }
    }
